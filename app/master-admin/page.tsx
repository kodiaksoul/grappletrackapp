                    ...
                    <td className="py-4 px-6 text-right">
                      {req.status === 'pending' ? (
                        <button
                          ...
                          className="bg-neon hover:bg-neon/90 disabled:opacity-50 text-main font-bold text-xs px-4 py-2 rounded-xl transition-all duration-200 shadow-md shadow-neon/5 hover:scale-105 active:scale-95"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 border border-gray-700 hover:border-neon hover:bg-neon/5 text-secondary hover:text-neon text-xs px-4 py-2 rounded-xl transition-all duration-200"
                        >
                          {copiedId === req.id ? (
                            <>
